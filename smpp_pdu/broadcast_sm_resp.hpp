...
#ifndef __SMPP_PDU_BROADCAST_SM_RESP_HPP__
#define __SMPP_PDU_BROADCAST_SM_RESP_HPP__
...
namespace smpp_pdu
{
  class PDU_broadcast_sm_resp : public SMPP_PDU
  {
    public:
      PDU_broadcast_sm_resp();
      PDU_broadcast_sm_resp(const char                  *b);
      PDU_broadcast_sm_resp(const PDU_broadcast_sm_resp &o);
