...
{
  //--------------------------------------------------------------------------------
  PDU_cancel_broadcast_sm::PDU_cancel_broadcast_sm() :
  ...
  //--------------------------------------------------------------------------------
  PDU_cancel_broadcast_sm::PDU_cancel_broadcast_sm(const char* b) :
    SMPP_PDU(b)
  {
    decode(b);
  }
  ...
  //--------------------------------------------------------------------------------
  PDU_cancel_broadcast_sm::PDU_cancel_broadcast_sm(const PDU_cancel_broadcast_sm &o) :
  ...
  //--------------------------------------------------------------------------------
  unsigned int PDU_cancel_broadcast_sm::getBodyLength()
  {
    return
      (
  ...
  //--------------------------------------------------------------------------------
  std::string PDU_cancel_broadcast_sm::encodeStandardParameters()
  {
    std::stringstream ss;
  ...
  //--------------------------------------------------------------------------------
  uint8_t *PDU_cancel_broadcast_sm::decodeStandardParameters(const uint8_t *buff)
  {
