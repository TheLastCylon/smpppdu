...
#ifndef __SMPP_PDU_CANCEL_SM_HPP__
#define __SMPP_PDU_CANCEL_SM_HPP__
...
namespace smpp_pdu
{
  class PDU_cancel_sm : public SMPP_PDU
  {
    public:
      PDU_cancel_sm();
      PDU_cancel_sm(const char          *b);
      PDU_cancel_sm(const PDU_cancel_sm &o);
      ...
      NormalSmeAddress destination_addr_;
