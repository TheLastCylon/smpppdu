...
#ifndef __SMPP_PDU_COMMAND_STATUS_HPP__
#define __SMPP_PDU_COMMAND_STATUS_HPP__
...
namespace smpp_pdu
{
  ...
  {
    public:
      CommandStatus(const uint32_t    &p) : val_(p) {}
      CommandStatus(const char        *p) : val_(decode(p)) {};
      CommandStatus(const std::string &p) : val_(decode(p.c_str())) {};

      operator uint32_t() const { return val_; }

      CommandStatus& operator = (const uint32_t &p) { val_ = p; return *this; } // Assign a 32 bit integer.

      uint32_t value() { return val_; }
      uint32_t decode(const char* b) { uint32_t x; memcpy(&x, &b[8], sizeof x); return smpp_pdu::ntoh32(x); }

    private:
      uint32_t val_;
      CommandStatus(); // must be constructed with a command id

    public:
      /** Status code values */
      enum type {
        ESME_ROK                 = 0x00000000, ESME_RINVMSGLEN          = 0x00000001, ESME_RINVCMDLEN          = 0x00000002, ESME_RINVCMDID           = 0x00000003,
        ESME_RINVBNDSTS          = 0x00000004, ESME_RALYBND             = 0x00000005, ESME_RINVPRTFLG          = 0x00000006, ESME_RINVREGDLVFLG       = 0x00000007,
        ESME_RSYSERR             = 0x00000008, ESME_RINVSRCADR          = 0x0000000A, ESME_RINVDSTADR          = 0x0000000B, ESME_RINVMSGID           = 0x0000000C,
        ESME_RBINDFAIL           = 0x0000000D, ESME_RINVPASWD           = 0x0000000E, ESME_RINVSYSID           = 0x0000000F, ESME_RCANCELFAIL         = 0x00000011,
        ESME_RREPLACEFAIL        = 0x00000013, ESME_RMSGQFUL            = 0x00000014, ESME_RINVSERTYP          = 0x00000015, ESME_RINVNUMDESTS        = 0x00000033,
        ESME_RINVDLNAME          = 0x00000034, ESME_RINVDESTFLAG        = 0x00000040, ESME_RINVSUBREP          = 0x00000042, ESME_RINVESMCLASS        = 0x00000043,
        ESME_RCNTSUBDL           = 0x00000044, ESME_RSUBMITFAIL         = 0x00000045, ESME_RINVSRCTON          = 0x00000048, ESME_RINVSRCNPI          = 0x00000049,
        ESME_RINVDSTTON          = 0x00000050, ESME_RINVDSTNPI          = 0x00000051, ESME_RINVSYSTYP          = 0x00000053, ESME_RINVREPFLAG         = 0x00000054,
        ESME_RINVNUMMSGS         = 0x00000055, ESME_RTHROTTLED          = 0x00000058, ESME_RINVSCHED           = 0x00000061, ESME_RINVEXPIRY          = 0x00000062,
        ESME_RINVDFTMSGID        = 0x00000063, ESME_RX_T_APPN           = 0x00000064, ESME_RX_P_APPN           = 0x00000065, ESME_RX_R_APPN           = 0x00000066,
        ESME_RQUERYFAIL          = 0x00000067, ESME_RINVTLVSTREAM       = 0x000000C0, ESME_RTLVNOTALLWD        = 0x000000C1, ESME_RINVTLVLEN          = 0x000000C2,
        ESME_RMISSINGTLV         = 0x000000C3, ESME_RINVTLVVAL          = 0x000000C4, ESME_RDELIVERYFAILURE    = 0x000000FE, ESME_RUNKNOWNERR         = 0x000000FF,
        ESME_RSERTYPUNAUTH       = 0x00000100, ESME_RPROHIBITED         = 0x00000101, ESME_RSERTYPUNAVAIL      = 0x00000102, ESME_RSERTYPDENIED       = 0x00000103,
        ESME_RINVDCS             = 0x00000104, ESME_RINVSRCADDRSUBUNIT  = 0x00000105, ESME_RINVDSTADDRSUBUNIT  = 0x00000106, ESME_RINVBCASTFREQINT    = 0x00000107,
        ESME_RINVBCASTALIAS_NAME = 0x00000108, ESME_RINVBCASTAREAFMT    = 0x00000109, ESME_RINVNUMBCAST_AREAS  = 0x0000010A, ESME_RINVBCASTCNTTYPE    = 0x0000010B,
        ESME_RINVBCASTMSGCLASS   = 0x0000010C, ESME_RBCASTFAIL          = 0x0000010D, ESME_RBCASTQUERYFAIL     = 0x0000010E, ESME_RBCASTCANCELFAIL    = 0x0000010F,
        ESME_RINVBCAST_REP       = 0x00000110, ESME_RINVBCASTSRVGRP     = 0x00000111, ESME_RINVBCASTCHANIND    = 0x00000112 };

      // A brief description of the command status
      inline static std::string description(const CommandStatus& p)
      {
        switch(p) {
          case ESME_ROK:                 return "No Error";                                                                                                                break;
          case ESME_RINVMSGLEN:          return "Message Length is invalid";                                                                                               break;
          case ESME_RINVCMDLEN:          return "Command Length is invalid";                                                                                               break;
          case ESME_RINVCMDID:           return "Invalid Command ID";                                                                                                      break;
          case ESME_RINVBNDSTS:          return "Incorrect BIND Status for given command";                                                                                 break;
          case ESME_RALYBND:             return "ESME Already in Bound State";                                                                                             break;
          case ESME_RINVPRTFLG:          return "Invalid Priority Flag";                                                                                                   break;
          case ESME_RINVREGDLVFLG:       return "Invalid Registered Delivery Flag";                                                                                        break;
          case ESME_RSYSERR:             return "System Error";                                                                                                            break;
          case ESME_RINVSRCADR:          return "Invalid Source Address";                                                                                                  break;
          case ESME_RINVDSTADR:          return "Invalid Destination Address";                                                                                             break;
          case ESME_RINVMSGID:           return "Message ID is invalid";                                                                                                   break;
          case ESME_RBINDFAIL:           return "Bind Failed";                                                                                                             break;
          case ESME_RINVPASWD:           return "Invalid Password";                                                                                                        break;
          case ESME_RINVSYSID:           return "Invalid System ID";                                                                                                       break;
          case ESME_RCANCELFAIL:         return "Cancel SM Failed";                                                                                                        break;
          case ESME_RREPLACEFAIL:        return "Replace SM Failed";                                                                                                       break;
          case ESME_RMSGQFUL:            return "Message Queue Full";                                                                                                      break;
          case ESME_RINVSERTYP:          return "Invalid Service Type";                                                                                                    break;
          case ESME_RINVNUMDESTS:        return "Invalid number of destinations";                                                                                          break;
          case ESME_RINVDLNAME:          return "Invalid Distribution List name";                                                                                          break;
          case ESME_RINVDESTFLAG:        return "Destination flag is invalid (submit_multi)";                                                                              break;
          case ESME_RINVSUBREP:          return "Submit w/replace functionality has been requested where it is either unsupported or inappropriate for the particular MC"; break;
          case ESME_RINVESMCLASS:        return "Invalid esm_class field data";                                                                                            break;
          case ESME_RCNTSUBDL:           return "Cannot Submit to Distribution List";                                                                                      break;
          case ESME_RSUBMITFAIL:         return "submit_sm, data_sm or submit_multi failed";                                                                               break;
          case ESME_RINVSRCTON:          return "Invalid Source address TON";                                                                                              break;
          case ESME_RINVSRCNPI:          return "Invalid Source address NPI";                                                                                              break;
          case ESME_RINVDSTTON:          return "Invalid Destination address TON";                                                                                         break;
          case ESME_RINVDSTNPI:          return "Invalid Destination address NPI";                                                                                         break;
          case ESME_RINVSYSTYP:          return "Invalid system_type field";                                                                                               break;
          case ESME_RINVREPFLAG:         return "Invalid replace_if_present flag";                                                                                         break;
          case ESME_RINVNUMMSGS:         return "Invalid number of messages";                                                                                              break;
          case ESME_RTHROTTLED:          return "Throttling Error (ESME has exceeded allowed message limits)";                                                             break;
          case ESME_RINVSCHED:           return "Invalid Scheduled Delivery Time";                                                                                         break;
          case ESME_RINVEXPIRY:          return "Invalid message validity period (Expiry time)";                                                                           break;
          case ESME_RINVDFTMSGID:        return "Predefined Message ID is Invalid or specified predefined message was not found";                                          break;
          case ESME_RX_T_APPN:           return "ESME Receiver Temporary App Error Code";                                                                                  break;
          case ESME_RX_P_APPN:           return "ESME Receiver Permanent App Error Code";                                                                                  break;
          case ESME_RX_R_APPN:           return "ESME Receiver Reject Message Error Code";                                                                                 break;
          case ESME_RQUERYFAIL:          return "query_sm request failed";                                                                                                 break;
          case ESME_RINVTLVSTREAM:       return "Error in the optional part of the PDU Body";                                                                              break;
          case ESME_RTLVNOTALLWD:        return "TLV not allowed";                                                                                                         break;
          case ESME_RINVTLVLEN:          return "Invalid Parameter Length";                                                                                                break;
          case ESME_RMISSINGTLV:         return "Expected TLV missing";                                                                                                    break;
          case ESME_RINVTLVVAL:          return "Invalid TLV Value";                                                                                                       break;
          case ESME_RDELIVERYFAILURE:    return "Transaction Delivery Failure";                                                                                            break;
          case ESME_RUNKNOWNERR:         return "Unknown Error";                                                                                                           break;
          case ESME_RSERTYPUNAUTH:       return "ESME Not authorised to use specified service_type";                                                                       break;
          case ESME_RPROHIBITED:         return "ESME Prohibited from using specified operation";                                                                          break;
          case ESME_RSERTYPUNAVAIL:      return "Specified service_type is unavailable";                                                                                   break;
          case ESME_RSERTYPDENIED:       return "Specified service_type is denied";                                                                                        break;
          case ESME_RINVDCS:             return "Invalid Data Coding Scheme";                                                                                              break;
          case ESME_RINVSRCADDRSUBUNIT:  return "Source Address Sub unit is Invalid";                                                                                      break;
          case ESME_RINVDSTADDRSUBUNIT:  return "Destination Address Sub unit is Invalid";                                                                                 break;
          case ESME_RINVBCASTFREQINT:    return "Broadcast Frequency Interval is invalid";                                                                                 break;
          case ESME_RINVBCASTALIAS_NAME: return "Broadcast Alias Name is invalid";                                                                                         break;
          case ESME_RINVBCASTAREAFMT:    return "Broadcast Area Format is invalid";                                                                                        break;
          case ESME_RINVNUMBCAST_AREAS:  return "Number of Broadcast Areas is invalid";                                                                                    break;
          case ESME_RINVBCASTCNTTYPE:    return "Broadcast Content Type is invalid";                                                                                       break;
          case ESME_RINVBCASTMSGCLASS:   return "Broadcast Message Class is invalid";                                                                                      break;
          case ESME_RBCASTFAIL:          return "broadcast_sm operation failed";                                                                                           break;
          case ESME_RBCASTQUERYFAIL:     return "query_broadcast_sm operation failed";                                                                                     break;
          case ESME_RBCASTCANCELFAIL:    return "cancel_broadcast_sm operation failed";                                                                                    break;
          case ESME_RINVBCAST_REP:       return "Number of Repeated Broadcasts is invalid";                                                                                break;
          case ESME_RINVBCASTSRVGRP:     return "Broadcast Service Group is invalid";                                                                                      break;
          case ESME_RINVBCASTCHANIND:    return "Broadcast Channel Indicator is invalid";                                                                                  break;
        } 
      ...
      // A long description of a command status, returns A long description of a command status */
