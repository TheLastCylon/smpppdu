...
#ifndef __SMPP_PDU_QUERY_BROADCAST_SM_HPP__
#define __SMPP_PDU_QUERY_BROADCAST_SM_HPP__
...
namespace smpp_pdu
{
  class PDU_query_broadcast_sm : public SMPP_PDU
  {
    public:
      PDU_query_broadcast_sm();
      PDU_query_broadcast_sm(const char                   *b);
      PDU_query_broadcast_sm(const PDU_query_broadcast_sm &o);
