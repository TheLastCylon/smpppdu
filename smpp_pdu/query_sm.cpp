...
namespace smpp_pdu
{
  ...
  //--------------------------------------------------------------------------------
  PDU_query_sm::PDU_query_sm(const char* b) :
    SMPP_PDU(b)
  {
    decode(b);
  }
  ...
  //--------------------------------------------------------------------------------
  PDU_query_sm::PDU_query_sm(const PDU_query_sm &o) :
  ...
  //--------------------------------------------------------------------------------
  unsigned int PDU_query_sm::getBodyLength()
  {
    return (
            message_id_ .length() +
            source_addr_.length()
  ...
  //--------------------------------------------------------------------------------
  std::string PDU_query_sm::encodeStandardParameters()
  {
    std::stringstream ss;
  ...
  //--------------------------------------------------------------------------------
  uint8_t *PDU_query_sm::decodeStandardParameters(const uint8_t *buff)
  {
