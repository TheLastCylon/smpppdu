...
{
  //--------------------------------------------------------------------------------
  PDU_submit_sm::PDU_submit_sm() :
    SMPP_PDU(CommandLength(MinLength), CommandId(CommandId::SubmitSm), CommandStatus(CommandStatus::ESME_ROK), SequenceNumber::Min) {}

  //--------------------------------------------------------------------------------
  PDU_submit_sm::PDU_submit_sm(const char* b) :
    SMPP_PDU(b)
  {
    decode(b);
  }
  ...
  //--------------------------------------------------------------------------------
  PDU_submit_sm::PDU_submit_sm(const smpp_pdu::PDU_submit_sm& o) :
  ...
  //--------------------------------------------------------------------------------
  unsigned int PDU_submit_sm::getBodyLength()
  {
    return (
             service_type           .length() +
             source_addr            .length() +
  ...
  //--------------------------------------------------------------------------------
  std::string PDU_submit_sm::encodeStandardParameters()
  {
    std::stringstream ss;
  ...
  //--------------------------------------------------------------------------------
  uint8_t *PDU_submit_sm::decodeStandardParameters(const uint8_t *buff)
  {
