...
#ifndef __SMPP_PDU_CANCEL_SM_RESP_HPP__
#define __SMPP_PDU_CANCEL_SM_RESP_HPP__

#include "header_pdu.hpp"

namespace smpp_pdu
{
  class PDU_cancel_sm_resp : public PDU_header
  {
    public:
      PDU_cancel_sm_resp()                            : PDU_header(CommandId::CancelSmResp) {}
      PDU_cancel_sm_resp(const char               *b) : PDU_header(b)                       {}
      PDU_cancel_sm_resp(const PDU_cancel_sm_resp &o) : PDU_header(o)                       {}
