...
namespace smpp_pdu
{
  ...
  //--------------------------------------------------------------------------------
  PDU_data_sm_resp::PDU_data_sm_resp(const char* b) :
    SMPP_PDU(b)
  {
    decode(b);
  }
  ...
  //--------------------------------------------------------------------------------
  PDU_data_sm_resp::PDU_data_sm_resp(const PDU_data_sm_resp &o) :
  ...
  //--------------------------------------------------------------------------------
  unsigned int PDU_data_sm_resp::getBodyLength()
  {
    return message_id_.length();
  }

  //--------------------------------------------------------------------------------
  std::string PDU_data_sm_resp::encodeStandardParameters()
  {
    return (std::string)message_id_;
  }

  //--------------------------------------------------------------------------------
  uint8_t *PDU_data_sm_resp::decodeStandardParameters(const uint8_t *buff)
  {
