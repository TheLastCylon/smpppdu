...
#ifndef __SMPP_PDU_ENQUIRE_LINK_HPP__
#define __SMPP_PDU_ENQUIRE_LINK_HPP__
...
namespace smpp_pdu
{
  class PDU_enquire_link : public PDU_header
  {
    public:
      PDU_enquire_link()                          : PDU_header(CommandId::EnquireLink) {};
      PDU_enquire_link(const char             *b) : PDU_header(b)                      {};
      PDU_enquire_link(const PDU_enquire_link &o) : PDU_header(o)                      {};
