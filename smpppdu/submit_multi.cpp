...
{
  //--------------------------------------------------------------------------------
  PDU_submit_multi::PDU_submit_multi() :
  ...
  //--------------------------------------------------------------------------------
  PDU_submit_multi::PDU_submit_multi(const char* b) :
    SMPP_PDU(b)
  {
    decode(b);
  }
  ...
  //--------------------------------------------------------------------------------
  PDU_submit_multi::PDU_submit_multi(const PDU_submit_multi &o) :
  ...
  //--------------------------------------------------------------------------------
  unsigned int PDU_submit_multi::getBodyLength()
  {
    return
      (
       service_type           .length() +
  ...
  //--------------------------------------------------------------------------------
  std::string PDU_submit_multi::encodeStandardParameters()
  {
    std::stringstream ss;
  ...
  //--------------------------------------------------------------------------------
  uint8_t *PDU_submit_multi::decodeStandardParameters(const uint8_t *buff)
  {
