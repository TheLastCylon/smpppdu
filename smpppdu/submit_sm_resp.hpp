...
#ifndef __SMPP_PDU_SUBMIT_SM_RESP_HPP__
#define __SMPP_PDU_SUBMIT_SM_RESP_HPP__
...
namespace smpp_pdu
{
  class PDU_submit_sm_resp : public SMPP_PDU
  {
    public:
      PDU_submit_sm_resp();
      PDU_submit_sm_resp(const char               *b);
      PDU_submit_sm_resp(const PDU_submit_sm_resp &o);
